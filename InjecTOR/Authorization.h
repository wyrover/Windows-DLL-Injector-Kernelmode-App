...
BOOL CheckOnline ( string License )
{
	...
	//string Url = decryptText ( "iuuq;00qspkfdusbjo/ofu0XpmgUfbn0DifdlMjdfotf/qiq@mjdfotf>" ); // Rain
	string Url = decryptText ( "iuuq;00xxx/qspkfdusbjo/ofu0MQNT0DifdlMjdfotf/qiq@mjdfotf>" ); // LPMS
	Url += License;
	...
	if ( !strcmp ( License.c_str (), GetLicense ().c_str () ) )
		return TRUE;
	else
		return FALSE;
}
